...
local Window = OrionLib:MakeWindow({Name = "PPCYT Tổng Hợp", Hid3.
250ePremium = false, SaveConfig = true, ConfigFolder = "dxl_bf"})
...
Tab4:AddButton({
	Name = "Zero Hub(Kaitun Get Key)",
	Callback = function()
         repeat wait(5) until game:IsLoaded()
         getgenv().Team = "Marines"
getgenv().Hide_Menu = false
getgenv().Auto_Execute = false
loadstring(game:HttpGet("https://raw.githubusercontent.com/ppcyt-2k/.lua/refs/heads/main/zerokaitun.lua"))()
  	end    
})
